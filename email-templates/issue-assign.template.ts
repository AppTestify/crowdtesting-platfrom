export const ISSUE_ASSIGN_TEMPLATE = `
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<body>
    <div class="container">
        ...
        <p>I wanted to inform you that a new issue has been assigned to you. Below are the details:</p>
        <div class="details">
            <p><strong>Issue:</strong> {name}</p>

...
import { Loader2, Plus, Package, Users, Clock, DollarSign, Bug, FileText, CheckCircle } from "lucide-react";
            ...
            <div className="relative flex items-start gap-4">
              ...
              <div className="flex-1 min-w-0">
                ...
                <DialogDescription className="text-gray-600 text-sm">
                  Create a new pricing package with testing configuration and features
                </DialogDescription>
              </div>
            </div>
          </div>
                      ...
                      <CardContent className="p-6">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                          ...
                          <FormField
                            ...
                            render={({ field }) => (
                              <FormItem>
                                <FormLabel className="text-sm font-medium text-gray-700 mb-2">Duration (Days)</FormLabel>
                                <FormControl>

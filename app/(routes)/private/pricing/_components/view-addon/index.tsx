...
import { Package, DollarSign, CheckCircle, XCircle, FileText } from "lucide-react";
          ...
          <div className="relative flex items-start gap-4">
            ...
            <div className="flex-1 min-w-0">
              <div className="flex items-center gap-3 mb-2">
                ...
                {addonData && getStatusBadge(addonData.isActive)}
              </div>
              <DialogTitle className="text-xl font-bold text-gray-900 mb-2">
                {addonData?.name || "Add-on Details"}
              </DialogTitle>
              <DialogDescription className="text-gray-600 text-sm">
                View comprehensive information about this add-on
              </DialogDescription>
            </div>
          </div>
        </div>
          ...
          {isViewLoading ? (
            <div className="flex items-center justify-center py-12">
              <div className="text-center">
                ...
                <p className="text-sm text-gray-500">Loading add-on details...</p>
              </div>
            </div>
          ) : addonData ? (
              ...
              <div className="space-y-4">
                ...
                <Card>
                  <CardContent className="p-6">
                    <DetailItem 
                      label="Status" 
                      value={addonData.isActive ? "Active" : "Inactive"}
                      icon={getStatusIcon(addonData.isActive)}
                    />
                  </CardContent>
                </Card>
              </div>
            ...
            <div className="text-center py-12">
              ...
              <p className="text-sm text-gray-500">No add-on data found.</p>
            </div>
          )}
        </div>
      </DialogContent>

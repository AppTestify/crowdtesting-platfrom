...
import { deleteTestCaseDataAttachmentService } from "@/app/_services/test-case-data.service";

export function TestCaseDataAttachmentRowActions({
    row,
    refreshAttachments,
    testCaseDataId,
    isView,
    ...
    const deleteAttachment = async () => {
        try {
            setIsLoading(true);
            const response = await deleteTestCaseDataAttachmentService(projectId, testCaseId, testCaseDataId, fileId);

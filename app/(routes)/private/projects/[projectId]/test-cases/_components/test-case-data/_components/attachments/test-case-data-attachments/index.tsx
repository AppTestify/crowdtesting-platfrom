...
import { getTestCaseDataAttachmentsService } from "@/app/_services/test-case-data.service";
import { TestCaseDataAttachmentRowActions } from "../test-case-data-attachment-row-action";
import { TestCaseDataAttachmentsProps } from "@/app/_interface/test-case-data";

export default function TestCaseDataAttachments({ testCaseDataId, testCaseId, isUpdate, isView, setAttachmentsData }: TestCaseDataAttachmentsProps) {
    const columns: ColumnDef<ITestCaseAttachmentDisplay>[] = [
        ...
        },
        {
            ...
            enableHiding: false,
            cell: ({ row }) => (
                <TestCaseDataAttachmentRowActions row={row} refreshAttachments={refreshAttachments}
                    testCaseDataId={testCaseDataId} isView={isView} testCaseId={testCaseId} />
            ),
        },
    ];
    ...
    const getAttachments = async () => {
        try {
            ...
            const response = await getTestCaseDataAttachmentsService(projectId, testCaseId, testCaseDataId);

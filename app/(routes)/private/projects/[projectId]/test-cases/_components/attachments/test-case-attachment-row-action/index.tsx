...
import { deleteTestCaseAttachmentService } from "@/app/_services/test-case.service";

export function TestCaseAttachmentRowActions({
    row,
    refreshAttachments,
    testCaseId,
    isView,
    ...
    const deleteAttachment = async () => {
        try {
            setIsLoading(true);
            const response = await deleteTestCaseAttachmentService(projectId, testCaseId, fileId);

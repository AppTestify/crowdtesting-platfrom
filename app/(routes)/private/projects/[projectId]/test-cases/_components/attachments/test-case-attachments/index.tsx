...
import { TestCaseAttachmentRowActions } from "../test-case-attachment-row-action";
import { ITestCaseAttachmentDisplay, TestCaseAttachmentsProps } from "@/app/_interface/test-case";
import { getTestCaseAttachmentsService } from "@/app/_services/test-case.service";

export default function TestCaseAttachments({ testCaseId, isUpdate, isView, setAttachmentsData }: TestCaseAttachmentsProps) {
    const columns: ColumnDef<ITestCaseAttachmentDisplay>[] = [
        ...
        },
        {
            ...
            enableHiding: false,
            cell: ({ row }) => (
                <TestCaseAttachmentRowActions row={row} refreshAttachments={refreshAttachments}
                    testCaseId={testCaseId} isView={isView} />
            ),
        },
    ];

          ...
          <div className="relative z-10 flex flex-col justify-center p-6 sm:p-8 lg:p-10 xl:p-12 text-white">
            ...
            <div className="mb-4 sm:mb-6">
              ...
              {/* <div className="grid grid-cols-3 gap-2 sm:gap-3 lg:gap-4 mb-3 sm:mb-4">
                <div className="text-center">
                  <div className="text-lg sm:text-xl lg:text-2xl xl:text-3xl font-bold text-green-300 mb-1">
                    1000+
                  </div>
            ...
            <div className="space-y-2 sm:space-y-3 mb-3 sm:mb-4">
              ...
              <div className="space-y-1.5 sm:space-y-2">
                <div className="flex items-start gap-2 sm:gap-3">
                  ...
                  <div>
                    <h4 className="font-semibold text-xs sm:text-sm lg:text-base mb-0.5">
                      Get Paid to Test
                    </h4>
                    <p className="text-blue-100 text-xs sm:text-sm">
                      Earn competitive payouts for each test case you complete —
                      from usability feedback to bug reports.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-2 sm:gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-blue-100 text-xs sm:text-sm">
                      Work from anywhere, anytime. You choose the projects that
                ...
                <div className="flex items-start gap-2 sm:gap-3">
                  ...
                  <div>
                    <h4 className="font-semibold text-xs sm:text-sm lg:text-base mb-0.5">
                      Test Exciting Products
                    </h4>
                    <p className="text-blue-100 text-xs sm:text-sm">
                      Be the first to experience and shape new apps, games, and
                      digital platforms before they go live.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-2 sm:gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-blue-100 text-xs sm:text-sm">
                      Access diverse testing opportunities across devices and
                      platforms. Build your QA portfolio with real-world
                      projects.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-2 sm:gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-blue-100 text-xs sm:text-sm">
                      Collaborate with a vibrant, diverse tester network and
            ...
            <div className="mb-3 sm:mb-4">
              ...
              <div className="flex items-center gap-2 sm:gap-3 opacity-80 flex-wrap">
                <div className="text-xs sm:text-sm font-semibold bg-white/20 px-2 py-1 rounded-full">
                  AUDIT360
                </div>
                <div className="text-xs sm:text-sm font-semibold bg-white/20 px-2 py-1 rounded-full">
                  MERCER
              ...
              <div className="w-full max-w-sm mx-auto">
                ...
                <div className="text-center mb-4 sm:mb-6 lg:mb-8">
                  ...
                  <p className="text-sm sm:text-base lg:text-lg text-gray-600 mb-3 sm:mb-4 lg:mb-6">
                    Join and start earning as a freelance tester.
                  </p>

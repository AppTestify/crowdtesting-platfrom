import { DB_CONNECTION_ERROR_MESSAGE, GENERIC_ERROR_MESSAGE, INVALID_INPUT_ERROR_MESSAGE, TOKEN_EXPIRED_MESSAGE } from "@/app/_constants/errors";
...
export async function POST(req: Request) {
    try {
        ...
        const updateResponse = await User.findOneAndUpdate({ email: email }, {

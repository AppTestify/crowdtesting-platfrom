...
import { IUser, User } from "@/app/_models/user.model";
...
//     // console.log("priicng: ", body.pricingId);

//     // Validate inputs
//     const projectValidation = projectSchema.safeParse(body.project);
//     // const packageValidation = packageSchema.safeParse(body.package);
//     // const userValidation = adminUserCreateSchema.safeParse(body.users);
...
//     // Step 0: Check if project already exists
...
//     savedProject.projectTabAccess = projectTabAccess._id;
...
//       // const existingUser = await User.findOne({ email, firstName }).lean();
//       // if (existingUser) {
//       //   return Response.json(
//       //     {
...
//   if (existingUser) {
//     // You can optionally update name or other details here if needed

...
export async function DELETE(
  ...
  try {
    ...
    const response = await TestCaseAttachment.findOneAndDelete({
      cloudId: attachmentId,
    });
    await TestCase.findByIdAndUpdate(response.issueId, {
    ...
    return Response.json({
      message: "Test case attachment deleted successfully",
    });
  } catch (error: any) {

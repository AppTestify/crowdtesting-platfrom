...
export async function DELETE(
  ...
  try {
    ...
    const response = await TestCycleAttachment.findOneAndDelete({
      cloudId: attachmentId,
    });
    await TestCycle.findByIdAndUpdate(response.testCycleId, {
    ...
    return Response.json({
      message: "Test cycle attachment deleted successfully",
    });
  } catch (error: any) {

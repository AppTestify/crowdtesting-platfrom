...
import { projectsBulkDeleteSchema } from "@/app/_schemas/project.schema";
...
export async function POST(req: Request) {
    try {
        ...
        const response = projectsBulkDeleteSchema.safeParse(body);
        ...
        const deleteResult = await Project.deleteMany(query);

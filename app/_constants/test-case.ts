...
export const testCaseAddList = [TestCase.STEPS, TestCase.ADDITIONAL_STEPS];
...
export const accordionBodyColors = [
  "bg-purple-50",
  "bg-orange-50",
  "bg-pink-50",
  "bg-blue-50",
...
export const TEST_EXECUTION_TYPE_LIST = [

export const enum EmailSubjects {
  ...
  CLIENT_SIGN_UP = "Welcome to AppTestify - Let's Build Exceptional Software Together!",
  TESTER_SIGN_UP = "Welcome to AppTestify - Unlock Your Potential and Start Earning!",
